...
const { default: VoidConnect, BufferJSON,generateLinkPreviewIfRequired, WA_DEFAULT_EPHEMERAL, proto, generateWAMessageContent, generateWAMessage, AnyMessageContent, prepareWAMessageMedia, areJidsSameUser, getContentType, downloadContentFromMessage, DisconnectReason, useMultiFileAuthState, fetchLatestBaileysVersion, MessageRetryMap, generateForwardMessageContent, updateProfilePicture, forwardMessage, generateWAMessageFromContent, generateMessageID, makeInMemoryStore, jidDecode } = require("@sampandey001/baileys") 
...
setTimeout(() => {
    ...
    async function syncdb() {
        ...
        global.log0 = fs.readFileSync(__dirname + "/assets/SocialLogo.jpg");
	global.devp = fs.readFileSync(__dirname + "/assets/Astro.jpg");
    ...
    global.scap = '*ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴀsᴛᴀ-ᴍᴅ* '
